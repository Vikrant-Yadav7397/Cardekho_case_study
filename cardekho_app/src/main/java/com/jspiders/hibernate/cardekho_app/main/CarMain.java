package com.jspiders.hibernate.cardekho_app.main;


import java.util.Scanner;
import com.jspiders.hibernate.cardekho_app.dto.CarDTO;
import com.jspiders.hibernate.cardekho_app.dao.CarDAO;
    ...
    public static void main(String[] args) {
        ...
        while (!exit) {
            ...
            switch (task) {
                ...
                newCar.setPrice(scanner.nextDouble());
