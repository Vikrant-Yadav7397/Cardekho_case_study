package com.jspiders.car_dekho_casestudy.operation;
...
public class Operation {
	 ...
	 public static boolean carDekho(Connection connection) {
	        System.out.println("*******************************");
	        System.out.println("Welcome To My Car Dekho App ");
	        System.out.println("*******************************");
	        ...
	        switch (choice1) {
	            case 1:
	                System.out.println("\n*************************************************");
	                System.out.println("Welcome To Add Car, Remove Car, Modify Car Details ");
	                System.out.println("1: Add Car");
	                System.out.println("2: Remove Car");
	                System.out.println("3: Modify Car");
	                System.out.println("4: Go Back In Menu");
	                System.out.println("\nEnter your Choice");
	    ...
	    public static void addCarDetails(Connection connection) {
	        String insertQuery = "INSERT INTO cars (carId, carName, carBrand, fuleType, price) VALUES (?, ?, ?, ?, ?)";
	    ...
	    private static void displayNewCarDetails(Connection connection) {
	        ...
	        String selectQuery = "SELECT * FROM cars WHERE carId IN (?)";
	    ...
	    public static void displayCarIds(Connection connection) {
	        String selectIdsQuery = "SELECT carId FROM cars";
	    ...
	    public static void removeCarDetails(Connection connection) {
	        ...
	        for (int i = 0; i < countToRemove; i++) {
	            ...
	            String deleteQuery = "DELETE FROM carsl WHERE carId = ?";
	    ...
	    public static void modifyCarDetails(Connection connection) {
	        ...
	        switch (modifyChoice) {
	            case 1:
	                updateQuery = "UPDATE cars SET carName = ? WHERE carId = ?";
	                columnToModify = "Car Name";
	                break;
	            case 2:
	                updateQuery = "UPDATE cars SET carBrand = ? WHERE carId = ?";
	                columnToModify = "Car Brand";
	                break;
	            case 3:
	                updateQuery = "UPDATE cars SET fuleType = ? WHERE carId = ?";
	                columnToModify = "Fuel Type";
	                break;
	            case 4:
	                updateQuery = "UPDATE cars SET price = ? WHERE carId = ?";
	    ...
	    private static boolean carExists(Connection connection, int carId) {
	        String checkQuery = "SELECT carId FROM cars WHERE carId = ?";
	    ...
	    public static void searchCarByEntity(Connection connection) {
	        ...
	        switch (searchChoice) {
	            case 1:
	                searchQuery = "SELECT * FROM cars WHERE carName = ?";
	                columnToSearch = "Car Name";
	                break;
	            case 2:
	                searchQuery = "SELECT * FROM cars WHERE carBrand = ?";
	                columnToSearch = "Car Brand";
	                break;
	            case 3:
	                searchQuery = "SELECT * FROM cars WHERE fuleType = ?";
	                columnToSearch = "Fuel Type";
	                break;
	            case 4:
	                searchQuery = "SELECT * FROM cars WHERE carId = ?";
	                columnToSearch = "Car ID";
	                break;
	            case 5:
	                searchQuery = "SELECT * FROM cars WHERE price = ?";
